...
3. Функция foreach в PHP:[https://www.php.net/manual/ru/control-structures.foreach.php]
4. Работа с файлами и директориями (scandir()):[https://www.php.net/manual/ru/function.scandir.php]
5. Сортировка массивов (usort()):[https://www.php.net/manual/ru/function.usort.php]